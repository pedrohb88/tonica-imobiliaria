...
imovelDBI.insereImovel(new Imovel({id: 0, rua: 'Augusto de Sá', bairro: 'Centro',
...
imovelDBI.insereImovel(new Imovel({id: 1, rua: 'João Barros de Freitas', bairro: 'Centro',
		numero: '12', cep: '290495-121', area: 100,
		descricao: 'Casa, dois andares, três quartos, dois banheiros, garagem, terraço, branco',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 270000,
		precoVenda: null, precoMinimoVenda: 300000}));
imovelDBI.insereImovel(new Imovel({id: 2, rua: 'Barão de Mesquita', bairro: 'Cidade Nova',
		numero: '334', cep: '290496-012', area: 190,
		descricao: 'Prédio, três andares, quatro quartos, três banheiros, garagem, terraço, azul claro',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 520000,
		precoVenda: null, precoMinimoVenda: 595000}));
imovelDBI.insereImovel(new Imovel({id: 3, rua: 'Primeiro de Março', bairro: 'Pacoval',
		numero: '461', cep: '290491-122', area: 90,
		descricao: 'Casa, um andar, dois quartos, um banheiro, verde água',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 120000,
		precoVenda: null, precoMinimoVenda: 153000}));
imovelDBI.insereImovel(new Imovel({id: 4, rua: 'Evaristo da Veiga', bairro: 'Pedrinhas',
		numero: '938', cep: '290498-876', area: 172,
		descricao: 'Casa, três andares, quatro quartos, dois banheiros, garagem, branco',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 320000,
		precoVenda: null, precoMinimoVenda: 350000}));
imovelDBI.insereImovel(new Imovel({id: 5, rua: 'Correia Dutra', bairro: 'Centro',
		numero: '66', cep: '290498-133', area: 172,
		descricao: 'Prédio, dez andares, dois quartos por andar, garagem, branco',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 320000,
		precoVenda: null, precoMinimoVenda: 350000}));
imovelDBI.insereImovel(new Imovel({id: 6, rua: 'Dois de Dezembro', bairro: 'Centro',
		numero: '723', cep: '290497-567', area: 172,
		descricao: 'Casa, um andar, cinco quartos, dois banheiros, garagem, rosa claro',
		proprietarioAntigo: 0, proprietarioNovo: null, precoCompra: 320000,
		precoVenda: null, precoMinimoVenda: 350000}));
imovelDBI.insereImovel(new Imovel({id: 7, rua: 'Vinícius de Moraes', bairro: 'São Lázaro',
		numero: '312', cep: '290498-132', area: 172,
